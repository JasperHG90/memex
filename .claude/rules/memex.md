...
Search results include `related_notes` and contradiction `links` (contradicts/weakens only). To explore temporal, semantic, or causal relationships, call `memex_get_memory_links(unit_ids=[...])`.
