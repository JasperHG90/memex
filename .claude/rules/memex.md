...
4. Resolved a tricky configuration/environment issue

User preferences / conventions are NOT note-shaped — those go to `memex_kv_write` per the KV-namespace rules in the system prompt.
