...
MEMEX_KV_PUT_DESC = (
    ...
    '\n'
    'Required: value (str), key (str). Key prefixes: `global:`, `user:`, '
    '`project:<id>:`, `app:<app-id>:`, `procedure:<verb>:<context-tag>`, '
    '`project:<id>:procedure:<verb>:<context-tag>`. Invalid → HTTP 400.\n'
    '\n'
    ...
    '\n'
    'PROCEDURES default to GLOBAL. Use `project:<id>:procedure:*` ONLY on '
    'explicit cue ("for this project"). Ambiguous? ASK — never infer scope.\n'
    '\n'
