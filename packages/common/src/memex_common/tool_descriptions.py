...
MEMEX_CASE_SUBMIT_DESC = (
    ...
    '("success"|"failure"|"mixed"), scope ("global"|"project:<id>"|'
    '"app:<id>"), scope_reasoning (one sentence why this scope fits). '
    'Recommended: situation, actions (ordered steps), lesson, project_id, '
    'case_of (UUID of the procedure you enacted — supply when known; it skips '
