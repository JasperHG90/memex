...
Revision ID: 040_outcome_per_unit_schema
Revises: 039_memory_unit_claim_type
...
revision: str = '040_outcome_per_unit_schema'
down_revision: Union[str, None] = '039_memory_unit_claim_type'
